...
This article describes a simple hardware hack: Making the [Parallella](http://rayhightower.com/blog/2014/07/07/parallella-quick-start-guide-with-gotchas/) run on solar energy. 
